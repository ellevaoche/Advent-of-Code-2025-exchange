...
.664.598..
"""
inp1 = """.......................153..988....502..842.........588.....441.468......481..........314...715.57............................163..992..512.
............805............*......#.............%...............*........=......%......................#......*.............-....#....*.....
...
def get_lines(inp: str) -> list[str]:
    lines_l = ["." + line + "." for line in inp.splitlines()]
    line = "." * len(lines_l[0])
    lines_l = [line] + lines_l + [line]
    return lines_l


def find_numbers(lines_l: list[str], debug: bool = False) -> list[tuple[int, int, int]]:
    num_pos_l = []
    for line_num, line in enumerate(lines_l):
        if debug:
            print(line)
        pos = 0
        pos_start = None
        for pos, char in enumerate(line):
            if char.isdigit():
                ...
                if pos_start is not None:
                    num_pos_l.append((line_num, pos_start, pos))
                    pos_start = None
    return num_pos_l


def main(inp: str, debug: bool = False):
    lines_l = get_lines(inp)
    num_pos_l = find_numbers(lines_l, debug)

    num_sum = 0
    for line_num, start, end in num_pos_l:
        if check_adjacent(lines_l, line_num, start, end):
            if debug:
                print(
                    f"Gültig:   {line_num}, {start}, {end}: {lines_l[line_num][start:end]}"
                )
            num_sum += int(lines_l[line_num][start:end])
        else:
            if debug:
                print(
                    f"Ungültig: {line_num}, {start}, {end}: {lines_l[line_num][start:end]}"
                )
    print(num_sum)


def check_adjacent(lines_l: list[str], line_num, start, end) -> bool:
    for pos in range(start - 1, end + 1):
        if lines_l[line_num - 1][pos] != "." or lines_l[line_num + 1][pos] != ".":
            return True
    if lines_l[line_num][start - 1] != "." or lines_l[line_num][end] != ".":
        return True
